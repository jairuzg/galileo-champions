...
const getResetPasswordLinkHTMLTemplate = (resetLink, deviceName) => {
    return `
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                    <a href="https://galileochampions.jaguergo.org/reset-password/${resetLink}" class="f-fallback button button--green" target="_blank">Reiniciar contraseña</a>
                                  </td>
                                </tr>
                              </table>
                            </td>
